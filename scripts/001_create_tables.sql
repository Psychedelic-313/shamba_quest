...
-- Each user can view, insert, and update their own profile
...
-- Allows all authenticated users to view all profiles for leaderboard

CREATE POLICY "Authenticated users can view all profiles for leaderboard" ON public.profiles FOR
